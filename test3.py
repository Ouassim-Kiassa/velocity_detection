        ...
        if use_dense_flow:
            ...
            if p1 is not None and st is not None:
                ...
                if len(good_new_final) > 0:
                    ...
                    p0 = None # Reset features if none are left in ROI
            else:
                p0 = None # Reset features if tracking failed
...
class WaterVelocityGUI:
    def __init__(self, master):
        ...
        # Max display dimensions for OpenCV setup windows
    ...
    def setup_ui(self):
        ...
        self.selected_setup_video_label = ttk.Label(mpp_calib_group, text="No video selected.", wraplength=350, justify=tk.LEFT) # wraplength might need adjustment
